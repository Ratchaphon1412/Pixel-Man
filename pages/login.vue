                ...
                >
                  <div class="relative flex items-center space-x-4 justify-center">
                    <svg
                      ...
                      fill="currentColor"
                      class="absolute left-0 w-5 text-gray-700 dark:text-white"
                      viewBox="0 0 16 16"
                    >
                      <path
                    ...
                    <span
                      class="block w-max font-semibold tracking-wide text-gray-700 dark:text-white text-sm transition duration-300 group-hover:text-black-700 sm:text-base"
